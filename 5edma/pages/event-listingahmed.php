        ...
        <main>
            ...
            <nav class="navbar navbar-expand-lg">                
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="index.html">
                        <img src="0hub.png" class="navbar-brand-image img-fluid" alt="Tiya Golf Club">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <h1 class="text-white mb-4 pb-2">Delivery staff listing</h1>

                            <a href="#section_3" class="btn custom-btn smoothscroll me-3">Scroll down</a>
                        </div>
            ...
            <section class="events-section section-padding" id="section_2">
                        ...
                        <div class="col-lg-12 col-12">
                            <h2 class="mb-lg-5 mb-4"> Meet Our delivery Staff</h2>
                        </div>
...
<div class="livreur-grid">
  <!-- Livreur elements will be added here -->
  <?php foreach ($list as $livreur) { ?>
