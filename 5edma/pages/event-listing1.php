...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../css/Product_Card_UI.css">
        <script src="Product_Card_UI.js"></script>
        <script src="shoping_cart.js"></script>
            ...
            <nav class="navbar navbar-expand-lg">                
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="index.html">
                        <img src="../images/0hub.png" class="navbar-brand-image img-fluid" alt="Tiya Golf Club">
                        <span class="navbar-brand-text">
                          
                            <small>green hub</small>
                        </span>
                    </a>
...
<ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
    <li><a class="dropdown-item" href="event-listing.html">products</a></li>
    <li><a class="dropdown-item" href="event-listing1.php">Inventory</a></li>
    <li><a class="dropdown-item" href="event-detail.html">producrs Detail</a></li>
</ul>
</li>
                        </ul>
                ...
                <div class="offcanvas-body d-flex flex-column">
                    <form class="custom-form member-login-form" action="#" method="post" role="form">
                        ...
                        <div class="member-login-form-body">
                            ...
                            <div class="text-center my-4">
                                <a href="/5EDMA/crud/back/view/pages/ajout.php">Sign Up</a>
                            </div>
                        </div>
                    </form>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <h1 class="text-white mb-4 pb-2">Product Listing</h1>
            ...
            <section class="events-section events-listing-section section-bg section-padding" id="section_3" style="color:blue;" >
                <div class="container" >
                    <div class="row" >
                              ...
                              <div class="products-area-wrapper tableView" id="demo11">
                                <div class="products-header">
                                  <div class="product-cell image">
                                    ...
                                    <div class="product-cell category">descrption<button class="sort-button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z"/></svg>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 me-auto mb-5 mb-lg-0">
                        <a class="navbar-brand d-flex align-items-center" href="index.html">
                            <img src="../images/hub0.png" class="navbar-brand-image img-fluid" alt="">
                            <span class="navbar-brand-text">
                             
                              
                                <small>  greenhub</small>
                            </span>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-3 col-12">
                        ...
                        <br>
                        <p class="copyright-text">Copyright © 2048 green hub</p>
                    </div>
