...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Product_Card_UI.css">
       ...
       <input type="submit" name="sub" value="add" />
        ...
        ?> 
         ...
         <div class="products-row" id=<?=$product['product_id'] ?>>
                                  ...
                                  <div class="product-cell price"><span class="cell-label"></span><button class="button-9" role="update" size="10">buy</button></div>
                                  <div class="product-cell price"><span class="cell-label"></span>
