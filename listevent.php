...
if (isset($_GET['firstName']) && !empty($_GET['firstName'])) {
  $list = $eventC-> searchevent($_GET['firstName']);
} else {
  $list = $eventC->listevent();
}
?>
...
<head>
  ...
  <link href="../view/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="../view/assets/css/argon-dashboard.css?v=2.0.4" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show   bg-gray-100">
 ...
 'google_translate_element'); 
      ...
      <a href="export.php" class="pdf"><button type="button" > Export Pdf </button></a>
      <button onclick="sortTable()">Sort type</button>
...
t"></script>
        ...
        <div>
              ...
              <table border="1" width="100%" class="table-responsive p-0"  id="event">
        <thead>
          <th>id_event</th>
          <th>place</th>
          <th>type</th>
  ...
  const tableRows = document.querySelectorAll('#event tbody tr');
...
<script>
var originalTable = document.getElementById("event").innerHTML;
  ...
  button.innerHTML = "Sort by type";
  button.onclick = sortTableBytype;
}
