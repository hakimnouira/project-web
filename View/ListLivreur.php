        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <h2>
              ...
              <h1 align="center">List of delivery guys</h1>
    ...
    <table border="1" width="80%" class="table-responsive p-0" align="right" >
        ...
        ?>
            <tr>
                ...
                <td><?= $livreur['email']; ?></td>
                <td><img src="<?= $livreur['image'];?>" alt="..." width="50 px" height="50px"></td>
...
function drawChart() {
    var data = google.visualization.arrayToDataTable(<?php echo json_encode($livreurc1->calculstat()); ?>);
