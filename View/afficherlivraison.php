...
<?php
<input type="text" id="mySearch" onkeyup="cherchelivraison(document.getElementById('mySearch'))" placeholder="Search.." title="Type in a category">
$livraisonc2 = new livraisonC();
$koskos=document.getElementById('mySearch');
$aa=$livraisonc2->cherchelivraison($koskos);
?>
$livraisonc2 = new livraisonC();
$koskos=document.getElementById('mySearch');
$aa=$livraisonc2->cherchelivraison($koskos);
